(function(S, N) {
	...
	(function(a) {
		...
		a.Fx.prototype = {
			dSetter: function() {
				var a = this.paths[0],
					...
					w;
				if (1 === r) l = this.toD;
				else if (n === g.length && 1 > r) for (; n--;) w = parseFloat(a[n]), l[n] = isNaN(w) ? g[n] : r * parseFloat(g[n] - w) + w;
				else l = g;
			...
			step: function(p) {
				...
				n.attr && !n.element ? p = !1 : p || g >= v + this.startTime ? (this.now = this.end, this.pos = 1, this.update(), l = e[this.prop] = !0, a.objectEach(e, function(a) {
					!0 !== a && (l = !1)
				}), l && w && w.call(n), p = !1) : (this.pos = r.easing((g - this.startTime) / v), this.now = this.start + (this.end - this.start) * this.pos, this.update(), p = !0);
				return p
			},
			initPath: function(p, g, l) {
				...
				function w(a, d) {
					for (var e = (f - a.length) / c; 0 < e && e--;) b = a.slice().splice(a.length / H - c, c * H), b[0] = d[f - c - e * c], m && (b[c - 6] = b[c - 2], b[c - 5] = b[c - 1]), [].splice.apply(a, [a.length / H, 0].concat(b)), y && e--
				}
				g = g || "";
				var v, e = p.startX,
					h = p.endX,
				...
				m && (r(g), r(l));
				if (e && h) {
					for (d = 0; d < e.length; d++) if (e[d] === h[0]) {
						v = d;
						break
		...
		a.pick = function() {
			var a = arguments,
				g, l, r = a.length;
			for (g = 0; g < r; g++) if (l = a[g], void 0 !== l && null !== l) return l
		};
		a.css = function(p, g) {
		...
		function(a, g) {
			...
			var l, r = a.length;
			for (l = 0; l < r; l++) if (g(a[l], l)) return a[l]
		};
		a.map = function(a, g) {
		...
		a.removeEvent = function(p, g, l) {
			...
			function n() {
				...
				p.nodeName && (g ? (e = {}, e[g] = !0) : e = v, a.objectEach(e, function(a, f) {
					if (v[f]) for (m = v[f].length; m--;) r(f, v[f][m])
				}))
			}
			var w, v = p.hcEvents,
				e;
		...
		a.fireEvent = function(p, g, l, r) {
			...
			var w, v;
			l = l || {};
			if (B.createEvent && (p.dispatchEvent || p.fireEvent)) n = B.createEvent("Events"), n.initEvent(g, !0, !0), a.extend(n, l), p.dispatchEvent ? p.dispatchEvent(n) : p.fireEvent(g, n);
			else if (n) for (n = n[g] || [], w = n.length, l.target || a.extend(l, {
		...
		a.seriesType = function(p, g, l, r, n) {
			...
			v[p] = a.extendClass(v[g] ||
			function() {}, r);
			v[p].prototype.type = p;
	...
	(function(a) {
		...
		a.Color.prototype = {
			...
			init: function(l) {
				var g, n, w, v;
				if ((this.input = l = this.names[l && l.toLowerCase ? l.toLowerCase() : ""] || l) && l.stops) this.stops = G(l.stops, function(e) {
					return new a.Color(e[1])
				});
				else if (l && l.charAt && "#" === l.charAt() && (g = l.length, l = parseInt(l.substr(1), 16), 7 === g ? n = [(l & 16711680) >> 16, (l & 65280) >> 8, l & 255, 1] : 4 === g && (n = [(l & 3840) >> 4 | (l & 3840) >> 8, (l & 240) >> 4 | l & 240, (l & 15) << 4 | l & 15, 1])), !n) for (w = this.parsers.length; w-- && !n;) v = this.parsers[w], (g = v.regex.exec(l)) && (n = v.parse(g));
				this.rgba = n || []
			},
			get: function(a) {
				var l = this.input,
					n = this.rgba,
					g;
				this.stops ? (g = p(l), g.stops = [].concat(g.stops), D(this.stops, function(n, e) {
			...
			brighten: function(a) {
				...
				else if (B(a) && 0 !== a) for (l = 0; 3 > l; l++) n[l] += g(255 * a), 0 > n[l] && (n[l] = 0), 255 < n[l] && (n[l] = 255);
				return this
			},
			...
			tweenTo: function(a, g) {
				var n = this.rgba,
					l = a.rgba;
				l.length && n && n.length ? (a = 1 !== l[3] || 1 !== n[3], g = (a ? "rgba(" : "rgb(") + Math.round(l[0] + (n[0] - l[0]) * (1 - g)) + "," + Math.round(l[1] + (n[1] - l[1]) * (1 - g)) + "," + Math.round(l[2] + (n[2] - l[2]) * (1 - g)) + (a ? "," + (l[3] + (n[3] - l[3]) * (1 - g)) : "") + ")") : g = a.input || "none";
				return g
			}
		};
		a.color = function(g) {
	...
	(function(a) {
		...
		f(D.prototype, {
			...
			colorGradient: function(z, k, b) {
				...
				}), "radialGradient" === O && I && !v(d.gradientUnits) && (e = d, d = q(d, u.getRadialAttr(I, e), {
					gradientUnits: "userSpaceOnUse"
				})), E(d, function(a, z) {
					"id" !== z && x.push(z, a)
				}), E(h, function(a) {
			...
			applyTextOutline: function(z) {
				...
				if ((d = z[0]) && "none" !== d && a.svg) {
					...
					for (e = z.length; e--;) u = z[e], "highcharts-text-outline" === u.getAttribute("class") && b(z, k.removeChild(u));
					q = k.firstChild;
					c(z, function(a, z) {
			...
			attr: function(a, k, b, u) {
				...
				"string" === typeof a ? c = (this[a + "Getter"] || this._defaultGetter).call(this, a, f) : (E(a, function(z, k) {
					O = !1;
					u || R(this, k);
			...
			crisp: function(a, k) {
				...
				a.height = Math.floor((a.height || z.height || 0) - 2 * u);
			...
			zIndexSetter: function(a, b) {
				...
				if (d) {
					...
					b = f.childNodes;
					for (y = b.length - 1; 0 <= y && !q; y--) if (z = b[y], d = z.zIndex, e = !v(d), z !== c) if (0 > a && e && !u && !y) f.insertBefore(c, b[y]), q = !0;
					else if (k(d) <= a || e && (!v(a) || 0 <= a)) f.insertBefore(c, b[y + 1] || null), q = !0;
		...
		f(B.prototype, {
			...
			buildText: function(a) {
				var b = a.element,
					...
					K = function(a) {
						var f;
						f = /(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : w || u.style.fontSize || 12;
					...
					q || C || v || H || -1 !== z.indexOf(" ") ? (y = /<.*class="([^"]+)".*>/, h = /<.*style="([^"]+)".*>/, A = /<.*href="([^"]+)".*>/, t && t.appendChild(b), z = q ? z.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [z], z = d(z, function(a) {
						...
						c(d, function(k) {
							if ("" !== k || 1 === d.length) {
								...
								A.test(k) && !f && (g(e, "onclick", 'location.href\x3d"' + k.match(A)[1] + '"'), g(e, "class", "highcharts-anchor"), n(e, {
									cursor: "pointer"
								}));
								...
								if (" " !== k) {
									...
									if (H) {
										...
										var O = [],
											l, C = K(e),
											F = a.rotation;
										for (v && (I = u.applyEllipsis(a, e, k, H)); !v && t && (c.length || O.length);) a.rotation = 0, l = u.getSpanWidth(a, e), k = l > H, void 0 === I && (I = k), k && 1 !== c.length ? (e.removeChild(e.firstChild), O.unshift(c.pop())) : (c = O, O = [], c.length && !R && (e = m.createElementNS(P, "tspan"), g(e, {
											dy: C,
											x: x
			...
			symbols: {
				...
				callout: function(a, k, b, u, d) {
					...
					d = d && d.anchorY;
					var e;
					e = ["M", a + f, k, "L", a + b - f, k, "C", a + b, k, a + b, k, a + b, k + f, "L", a + b, k + u - f, "C", a + b, k + u, a + b, k + u, a + b - f, k + u, "L", a + f, k + u, "C", a, k + u, a, k + u, a, k + u - f, "L", a, k + f, "C", a, k, a, k, a + f, k];
			...
			text: function(a, k, b, u) {
				...
				u || (a.xSetter = function(a, k, b) {
					var u = b.getElementsByTagName("tspan"),
						...
						c;
					for (c = 0; c < u.length; c++) d = u[c], d.getAttribute(k) === f && d.setAttribute(k, a);
					b.setAttribute(k, a)
				});
				return a
			},
			...
			label: function(k, b, d, e, y, h, m, A, M) {
				...
				O = function() {
					...
					K && (t || (I.box = t = z.symbols[e] || r ? z.symbol(e) : z.rect(), t.addClass(("button" === M ? "" : "highcharts-label-box") + (M ? " highcharts-" + M + "-box" : "")), t.add(I), a = p(), k.x = a, k.y = (A ? -J : 0) + a), k.width = Math.round(I.width), k.height = Math.round(I.height), t.attr(f(k, Q)), Q = {})
				};
				L = function() {
					var a = l + n,
						k;
					...
					if (this.parentGroup = a) {
						if (b = a.div, !b) {
							...
							g(c.reverse(), function(a) {
								function e(k, b) {
									a[b] = k;
									n ? q[h.getTransformKey()] = "translate(" + (a.x || a.translateX) + "px," + (a.y || a.translateY) + "px)" : "translateX" === b ? q.left = k + "px" : q.top = k + "px";
									a.doTransform = !0
								}
	...
	(function(a) {
		...
		function B() {
			var n = a.defaultOptions.global,
				...
				c = m.concat(["Milliseconds", "Seconds"]);
	...
	(function(a) {
		...
		a.Tick.prototype = {
			...
			handleOverflow: function(a) {
				...
				else if (e = n + (1 - b) * d, n - b * d < m ? H = a.x + H * (1 - b) - m : e > h && (H = h - a.x + H * b, J = -1), H = Math.min(y, H), H < y && "center" === g.labelAlign && (a.x += J * (y - H - b * (y - Math.min(d, H)))), d > H || g.autoRotation && (c.styles || {}).width) t = H;
			...
			getPosition: function(a, g, l, e) {
				...
				return {
					...
					y: a ? c - h.bottom + h.offset - (h.opposite ? h.height : 0) : c - h.translate(g + l, null, null, e) - h.transB
				}
			},
			...
			renderGridLine: function(a, g, l) {
				...
				if (!a && m && (a = e.getPlotLinePath(f + d, m.strokeWidth() * l, a, !0))) m[this.isNew ? "attr" : "animate"]({
					d: a,
					opacity: g
				})
			},
	...
	var V = function(a) {
			...
			a.extend(F.prototype, {
				...
				init: function(a, b) {
					...
					u.categories = f.categories || u.hasNames;
					u.names = u.names || [];
					...
					u.max = null;
					u.min = null;
					u.crosshair = C(f.crosshair, q(a.options.tooltip.crosshairs)[k ? 0 : 1], !1);
				...
				defaultLabelFormatter: function() {
					...
					else if (h && 1E3 <= k) for (; h-- && void 0 === m;) d = Math.pow(e, h + 1), k >= d && 0 === 10 * b % d && null !== q[h] && 0 !== b && (m = a.numberFormat(b / d, -1) + q[h]);
				...
				getSeriesExtremes: function() {
					...
					e(a.series, function(k) {
						if (k.visible || !u.options.chart.ignoreHiddenSeries) {
							...
							if (a.isXAxis) d = k.xData, d.length && (k = p(d), c = G(d), H(k) || k instanceof Date || (d = b(d, H), k = p(d)), a.dataMin = Math.min(C(a.dataMin, d[0], k), k), a.dataMax = Math.max(C(a.dataMax, d[0], c), c));
				...
				getMinorTickPositions: function() {
					var a = this,
						...
						q = a.max + q,
						m = q - h;
					if (m && m / f < a.len / 3) if (a.isLog) e(this.paddedTicks, function(k, b, u) {
						b && c.push.apply(c, a.getLogTickPositions(f, u[b - 1], u[b], !0))
					});
					else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval()) c = c.concat(a.getTimeTicks(a.normalizeTimeTickInterval(f), h, q, b.startOfWeek));
					else for (b = h + (d[0] - h) % f; b <= q && b !== c[0]; b += f) c.push(b);
				...
				adjustForMinRange: function() {
					...
					this.isXAxis && void 0 === this.minRange && !this.isLog && (n(a.min) || n(a.max) ? this.minRange = null : (e(this.series, function(a) {
						y = a.xData;
						for (h = A = a.xIncrement ? 1 : y.length - 1; 0 < h; h--) if (m = y[h] - y[h - 1], void 0 === q || m < q) q = m
				...
				getClosest: function() {
					...
					this.categories ? a = 1 : e(this.series, function(k) {
						var b = k.closestPointRange,
							u = k.visible || !k.chart.options.chart.ignoreHiddenSeries;
				...
				setTickInterval: function(k) {
					...
					L = C(b.userMin, c.min);
					B = C(b.userMax, c.max);
					t ? (b.linkedParent = d[b.coll][c.linkedTo], d = b.linkedParent.getExtremes(), b.min = C(d.min, d.dataMin), b.max = C(d.max, d.dataMax), c.type !== b.linkedParent.options.type && a.error(11, 1)) : (!J && n(r) && (b.dataMin >= r ? (p = r, g = 0) : b.dataMax <= r && (w = r, x = 0)), b.min = C(L, p, b.dataMin), b.max = C(B, w, b.dataMax));
					...
					H(c.softMin) && (b.min = Math.min(b.min, c.softMin));
					...
					b.tickInterval = b.min === b.max || void 0 === b.min || void 0 === b.max ? 1 : t && !E && v === b.linkedParent.options.tickPixelInterval ? E = b.linkedParent.tickInterval : C(E, this.tickAmount ? (b.max - b.min) / Math.max(this.tickAmount - 1, 1) : void 0, F ? 1 : (b.max - b.min) * v / Math.max(b.len, v));
					...
					y || q || E || (b.tickInterval = K(b.tickInterval, null, f(b.tickInterval), C(c.allowDecimals, !(.5 < b.tickInterval && 5 > b.tickInterval && 1E3 < b.max && 9999 > b.max)), !! this.tickAmount));
				...
				zoom: function(a, b) {
					...
					if (a !== this.min || b !== this.max) this.allowZoomOutside || (n(k) && (a < f && (a = f), a > c && (a = c)), n(d) && (b < f && (b = f), b > c && (b = c))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {
						trigger: "zoom"
					});
					return !0
				},
				setAxisSize: function() {
					var b = this.chart,
						...
						d = this.left = Math.round(a.relativeLength(C(d.left, b.plotLeft + c[3]), b.plotWidth, b.plotLeft));
				...
				renderUnsquish: function() {
					...
					if (this.autoRotation) E > m && E > A.h ? y.rotation = this.labelRotation : this.labelRotation = 0;
						...
						width: m + "px"
					}, !x)) for (g.textOverflow = "clip", l = d.length; !q && l--;) if (n = d[l], m = c[n].label) m.styles && "ellipsis" === m.styles.textOverflow ? m.css({
						textOverflow: "clip"
				...
				getOffset: function() {
					...
					A = a.hasData();
					a.showAxis = t = A || C(c.showEmpty, !0);
				...
				drawCrosshair: function(a, b) {
					...
					this.crosshair && !1 !== (n(b) || !k) ? (k ? n(b) && (f = this.isXAxis ? b.plotX : this.len - b.plotY) : f = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos), n(f) && (d = this.getPlotLinePath(b && (this.isXAxis ? b.x : C(b.stackY, b.y)), null, null, null, f) || null), n(d) ? (b = this.categories && !this.isRadial, q || (this.cross = q = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (b ? "category " : "thin ") + c.className).attr({
						...
						stroke: c.color || (b ? g("#ccd6eb").setOpacity(.25).get() : "#cccccc"),
	...
	(function(a) {
		...
		D.prototype.getTimeTicks = function(a, c, f, b) {
			...
			if (g(c)) {
				...
				if (x >= h.day) t[B.hcSetDate](x >= h.month ? 1 : C * Math.floor(t[B.hcGetDate]() / C));
				...
				n = t.getTime();
				for (c = 1; n < f;) d.push(n), n = x === h.year ? K(v + c * C, 0) : x === h.month ? K(v, b + c * C) : !q || x !== h.day && x !== h.week ? q && x === h.hour ? K(v, b, A, E + c * C, 0, 0, L) - L : n + x * C : K(v, b, A + c * C * (x === h.day ? 1 : 7)), c++;
				d.push(n);
	...
	(function(a) {
		...
		D.prototype.getLogTickPositions = function(a, r, n, w) {
			...
			else if (.08 <= a) for (var e = Math.floor(r), f, b, d, y, H, l = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; e < n + 1 && !H; e++) for (b = l.length, f = 0; f < b && !H; f++) d = m(h(e) * l[f]), d > r && (!w || y <= n) && void 0 !== y && c.push(y), y > n && (H = !0), y = d;
			else r = h(r), n = h(n), a = w ? this.getMinorTickInterval() : l.tickInterval, a = g("auto" === a ? null : a, this._minorAutoInterval, l.tickPixelInterval / (w ? 5 : 1) * (n - r) / ((w ? e / this.tickPositions.length : e) || 1)), a = p(a, null, B(a)), c = G(this.getLinearTickPositions(a, r, n), m), w || (this._minorAutoInterval = a / 5);
	...
	(function(a, D) {
		...
		a.extend(D.prototype, {
			getPlotBandPath: function(a, e) {
				...
				if (m && h) for (a && (d = m.toString() === h.toString(), b = 0), a = 0; a < m.length; a += 6) f && h[a + 1] === m[a + 1] ? (h[a + 1] += b, h[a + 4] += b) : f || h[a + 2] !== m[a + 2] || (h[a + 2] += b, h[a + 5] += b), c.push("M", m[a + 1], m[a + 2], "L", m[a + 4], m[a + 5], h[a + 4], h[a + 5], h[a + 1], h[a + 2], "z"), c.flat = d;
				return c
			},
			...
			removePlotBandOrLine: function(a) {
				for (var e = this.plotLinesAndBands, h = this.options, m = this.userOptions, c = e.length; c--;) e[c].id === a && e[c].destroy();
	...
	(function(a) {
		...
		a.Tooltip.prototype = {
			...
			getAnchor: function(a, e) {
				...
				}), m /= a.length, g /= a.length, c = [b ? f.plotWidth - g : m, this.shared && !b && 1 < a.length && e ? e.chartY - d : b ? f.plotHeight - m : g]);
			...
			getPosition: function(a, e, c) {
				var f = this.chart,
					...
					x = function(a, c, f, k, e, q) {
						...
						else if (m) d[a] = Math.min(q - f, 0 > u - h ? u : u - h);
			...
			refresh: function(a, e) {
				...
				f.enabled && (clearTimeout(this.hideTimer), this.followPointer = w(d)[0].series.tooltipOptions.followPointer, h = this.getAnchor(d, e), e = h[0], b = h[1], !m || d.series && d.series.noSharedTooltip ? m = d.getLabelConfig() : (B(d, function(a) {
					...
					x: d[0].category,
					y: d[0].y
				}, m.points = g, d = d[0]), this.len = g.length, m = c.call(m, this), t = d.series, this.distance = n(t.tooltipOptions.distance, 16), !1 === m ? this.hide() : (c = this.getLabel(), this.isHidden && c.attr({
					opacity: 1
				...
				B(e.slice(0, m.length + 1), function(a, e) {
					if (!1 !== a) {
						...
						x || (y.tt = x = d.label(null, null, null, "callout", null, null, g.useHTML).addClass("highcharts-tooltip-box " + A).attr({
							...
							stroke: g.borderColor || e.color || q.color || "#333333",
			...
			getXDateFormat: function(a, e, c) {
				...
				return (f ? this.getDateFormat(f, a.x, c.options.startOfWeek, e) : e.day) || e.year
			},
	...
	(function(a) {
		...
		a.Pointer.prototype = {
			init: function(a, d) {
				...
				this.pinchDown = [];
				this.lastValidTouch = {};
				f && (a.tooltip = new f(a, d.tooltip), this.followTouchMove = m(d.tooltip.followTouchMove, !0));
				this.setDOMEvents()
			},
			...
			drag: function(a) {
				...
				E && E.touch || (f < m ? f = m : f > m + n && (f = m + n), e < l ? e = l : e > l + q && (e = l + q), this.hasDragged = Math.sqrt(Math.pow(F - f, 2) + Math.pow(k - e, 2)), 10 < this.hasDragged && (A = b.isInsidePlot(F - m, k - l), b.hasCartesianSeries && (this.zoomX || this.zoomY) && A && !u && !E && (this.selectionMarker = E = b.renderer.rect(m, l, h ? 1 : n, g ? 1 : q, 0).attr({
	...
	(function(a) {
		...
		G(a.Pointer.prototype, {
			pinchTranslate: function(a, g, l, p, e, h) {
				this.zoomHor && this.pinchTranslateDirection(!0, a, g, l, p, e, h);
			...
			pinchTranslateDirection: function(a, g, l, p, e, h, m, c) {
				...
				l();
				g = v;
				g < w.min ? (g = w.min, u = !0) : g + t > w.max && (g = w.max - t, u = !0);
			...
			pinch: function(a) {
				...
				}), n.res = !0) : n.followTouchMove && 1 === h ? this.runPointActions(n.normalize(a)) : v.length && (f || (n.selectionMarker = f = G({
					destroy: g,
					touch: !0
	...
	(function(a) {
		...
		a.Legend.prototype = {
			...
			setText: function(c) {
				var f = this.options;
				c.legendItem.attr({
					text: f.labelFormat ? a.format(f.labelFormat, c) : f.labelFormatter.call(c)
				})
			},
			renderItem: function(a) {
				...
				F || (a.legendGroup = b.g("legend-item").addClass("highcharts-" + u.type + "-series highcharts-color-" + a.colorIndex + (I ? " " + I : "") + (k ? " highcharts-series-" + a.index : "")).attr({
					...
					align: r ? "left" : "right",
					zIndex: 2
				}).add(a.legendGroup), this.baseline || (h = m.fontSize, this.fontMetrics = b.fontMetrics(h, F), this.baseline = this.fontMetrics.f + 3 + E, F.attr("y", this.baseline)), this.symbolHeight = d.symbolHeight || this.fontMetrics.f, u.drawLegendSymbol(this, a), this.setItemEvents && this.setItemEvents(a, F, P), v && this.createCheckboxForItem(a));
			...
			handleOverflow: function(a) {
				...
				a > b && !1 !== x.enabled ? (this.clipHeight = l = Math.max(b - 20 - this.titleHeight - m, 0), this.currentPage = w(this.currentPage, 1), this.fullHeight = a, g(F, function(a, b) {
					...
					c !== E && (E = c)
				}), n || (n = c.clipRect = d.clipRect(0, m, 9999, 0), c.contentGroup.clip(n)), k(l), q || (this.nav = q = d.g().attr({
					zIndex: 1
		...
		a.LegendSymbolMixin = {
			...
			drawLineMarker: function(a) {
				...
				b && !1 !== b.enabled && (c = Math.min(w(b.radius, h), h), 0 === this.symbol.indexOf("url") && (b = n(b, {
					width: e,
					height: e
				}), c = 0), this.legendSymbol = b = g.symbol(this.symbol, d / 2 - c, a - c, 2 * c, 2 * c, b).addClass("highcharts-point").add(m), b.isMarker = !0)
			}
		};
	...
	(function(a) {
		...
		c(P.prototype, {
			...
			init: function(b, c) {
				...
				b.series = null;
				d = x(n, b);
				for (f in d.plotOptions) d.plotOptions[f].tooltip = e[f] && x(e[f].tooltip) || void 0;
			...
			redraw: function(d) {
				...
				this.layOutTitles();
				for (d = k.length; d--;) if (E = k[d], E.options.stacking && (g = !0, E.isDirty)) {
					l = !0;
					break
				}
				if (l) for (d = k.length; d--;) E = k[d], E.options.stacking && (E.isDirty = !0);
				m(k, function(a) {
			...
			layOutTitles: function(a) {
				...
				m(["title", "subtitle"], function(a) {
					...
					d && (q = e.style.fontSize, q = f.fontMetrics(q, d).b, d.css({
						...
						y: a + q
					}, e), !1, "spacingBox"), e.floating || e.verticalAlign || (b = Math.ceil(b + d.getBBox(e.useHTML).height)))
				}, this);
			...
			temporaryDisplay: function(b) {
				var c = this.renderTo;
				if (b) for (; c && c.style;) c.hcOrigStyle && (a.css(c, c.hcOrigStyle), delete c.hcOrigStyle), c.hcOrigDetached && (g.body.removeChild(c), c.hcOrigDetached = !1), c = c.parentNode;
				else for (; c && c.style;) {
			...
			getContainer: function() {
				...
				y(k) && v[k] && v[k].hasRendered && v[k].destroy();
				...
				this.renderer = new(a[f.renderer] || a.Renderer)(b, k, e, null, f.forExport, d.exporting && d.exporting.allowHTML);
	...
	(function(a) {
		...
		a.Point.prototype = {
			...
			optionsToObject: function(a) {
				...
				else if (r(a)) for (!c && a.length > b && (g = typeof a[0], "string" === g ? e.name = a[0] : "number" === g && (e.x = a[0]), d++); l < b;) c && void 0 === a[d] || (e[f[l]] = a[d]), d++, l++;
		...
		a.Series = a.seriesType("line", null, {
			...
			insert: function(a) {
				var c = this.options.index,
					d;
				if (b(c)) {
					for (d = a.length; d--;) if (c >= J(a[d].options.index, a[d]._i)) {
						a.splice(d + 1, 0, this);
						break
					} - 1 === d && a.unshift(this);
					d += 1
			...
			setOptions: function(a) {
				...
				this.userOptions = a;
				b = y(e, d.series, a);
				this.tooltipOptions = y(r.tooltip, r.plotOptions.series && r.plotOptions.series.tooltip, r.plotOptions[this.type].tooltip, c.tooltip.userOptions, d.series && d.series.tooltip, d[this.type].tooltip, a.tooltip);
			...
			setData: function(c, e, h, g) {
				...
				l = c.length;
				e = J(e, !0);
				if (!1 !== g && l && m === l && !k.cropped && !k.hasGroupedData && k.visible) v(c, function(a, b) {
					...
					if (E && l > E) {
						...
						if (b(n)) for (h = 0; h < l; h++) y[h] = this.autoIncrement(), p[h] = c[h];
						else if (f(n)) if (r) for (h = 0; h < l; h++) n = c[h], y[h] = n[0], p[h] = n.slice(1, r + 1);
						else for (h = 0; h < l; h++) n = c[h], y[h] = n[0], p[h] = n[1];
						else a.error(12)
					} else for (h = 0; h < l; h++) void 0 !== c[h] && (n = {
						series: k
			...
			processData: function(b) {
				...
				if (n && this.sorted && !m && (!g || f > g || this.forceCrop)) if (c[f - 1] < y || c[0] > p) c = [], d = [];
			...
			cropData: function(a, b, c, d) {
				var f = a.length,
					...
					q;
				for (q = 0; q < f; q++) if (a[q] >= c) {
					e = Math.max(0, q - g);
					break
				}
				for (c = q; c < f; c++) if (a[c] > d) {
					h = c + g;
					break
				}
				return {
			...
			generatePoints: function() {
				...
				this.options.keys = a;
				if (c && (g !== (d = c.length) || n)) for (y = 0; y < d; y++) y !== l || n || (y += g), c[y] && (c[y].destroyElements(), c[y].plotX = void 0);
				this.data = c;
				this.points = x
			},
			getExtremes: function(a) {
				...
				e = a.length;
				for (t = 0; t < e; t++) if (m = d[t], n = a[t], l = (b(n, !0) || f(n)) && (!c.positiveValuesOnly || n.length || 0 < n), m = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (d[t + 1] || m) >= g && (d[t - 1] || m) <= q, l && m) if (l = n.length) for (; l--;) null !== n[l] && (k[h++] = n[l]);
				else k[h++] = n;
				this.dataMin = p(k);
				this.dataMax = G(k)
			},
			translate: function() {
				...
				for (a = 0; a < h; a++) {
					...
					K.plotX = y = g(Math.min(Math.max(-1E5, d.translate(H, 0, 0, 0, 1, m, "flags" === this.type)), 1E5));
			...
			getGraphPath: function(a, b, c) {
				...
				v(a, function(k, h) {
					...
					k.isNull && !w(b) && 0 < h ? l = !f.connectNulls : k.isNull && !b ? l = !0 : (0 === h || l ? h = ["M", k.plotX, k.plotY] : d.getPointSpline ? h = d.getPointSpline(a, k, h) : e ? (h = 1 === e ? ["L", n.plotX, t] : 2 === e ? ["L", (n.plotX + q) / 2, n.plotY, "L", (n.plotX + q) / 2, t] : ["L", q, n.plotY], h.push("L", q, t)) : h = ["L", q, t], m.push(k.x), e && m.push(k.x), g.push.apply(g, h), l = !1)
				});
				g.xMap = m;
			...
			searchKDTree: function(a, b) {
				function c(a, b, k, g) {
					var l = b.point,
						m = d.kdAxisArray[k % g],
						q, n, t = l;
					n = w(a[f]) && w(l[f]) ? Math.pow(a[f] - l[f], 2) : null;
	...
	(function(a) {
		...
		a.StackItem = function(a, h, g, c, f) {
			...
			this.alignOptions = {
				...
				verticalAlign: h.verticalAlign || (b ? "middle" : g ? "bottom" : "top"),
				y: w(h.y, b ? 4 : g ? 14 : -6),
				x: w(h.x, b ? g ? -6 : 6 : 0)
			};
		...
		v.prototype.modifyStacks = function() {
			...
			a[b + "Stacker"] && l([h, "-" + h], function(d) {
				for (var e = c.length, h, l; e--;) if (h = c[e], f = a.getStackIndicator(f, h, a.index, d), l = (h = g[d] && g[d][h]) && h.points[f.key]) a[b + "Stacker"](l, h, e)
			})
		};
	...
	(function(a) {
			...
			update: function(a, c, g) {
				...
				r("xAxis yAxis zAxis series colorAxis pane".split(" "), function(b) {
					a[b] && (r(K(a[b]), function(a, c) {
						...
						if (!c && g) if ("series" === b) m.addSeries(a, !1).touched = !0;
		...
		w(y.prototype, {
			update: function(a, b, c, f) {
				function e() {
					...
					"point" === n.legendType && (t.isDirtyLegend = !0);
					b && t.redraw(c)
				}
				var h = this,
					g = h.series,
		...
		w(H.prototype, {
			addPoint: function(a, b, c, f) {
				...
				x = m.x;
				q = n.length;
				if (this.requireSorting && x < n[q - 1]) for (t = !0; q && n[q - 1] > x;) q--;
		...
		l("area", "line", {
			...
			getStackPoints: function(g) {
				...
				if (this.options.stacking) {
					for (H = 0; H < g.length; H++) g[H].leftNull = g[H].rightNull = null, m[g[H].x] = g[H];
					...
					B(r, function(a, f) {
						...
						if (m[a] && !m[a].isNull) l.push(m[a]), B([-1, 1], function(e) {
							var g = 1 === e ? "rightNull" : "leftNull",
								l = 0,
								p = h[r[f + e]];
							if (p) for (H = c; 0 <= H && H < b;) n = p.points[H], n || (H === c ? m[a][g] = !0 : d[H] && (t = h[a].points[H]) && (l -= t[1] - t[0])), H += y;
			...
			getGraphPath: function(a) {
				var l = g.prototype.getGraphPath,
					...
					K = function(h, g, l) {
						...
						l = m[l + "Cliff"] || 0;
						var n, p, m = !0;
						l || t ? (n = (t ? h[0] : h[1]) + l, p = h[0] + l, m = !! t) : !v && a[g] && a[g].isNull && (n = p = H);
						void 0 !== n && (f.push({
							plotX: d,
				...
				for (h = 0; h < a.length; h++) if (m = a[h].isNull, d = p(a[h].rectPlotX, a[h].plotX), t = p(a[h].yBottom, J), !m || r) r || K(h, h - 1, "left"), m && !v && r || (f.push(a[h]), c.push({
					x: h,
					plotX: d,
					plotY: t
				})), r || K(h, h + 1, "right");
			...
			drawGraph: function() {
				...
				B(v, function(e) {
					var h = e[0],
						g = a[h];
					g ? (g.endX = a.preventGraphAnimation ? null : l.xMap, g.animate({
						d: l
			...
			translate: function() {
				...
				G(a.points, function(c) {
					var e = r(c.yBottom, d),
						...
						n = Math.min(h, e),
						y, k = Math.max(h, e) - n;
					p && Math.abs(k) < p && (k = p, y = !f.reversed && !c.negative || f.reversed && c.negative, c.y === b && a.dataMax <= b && f.min < b && (y = !y), n = Math.abs(n - d) > p ? e - p : d - (y ? p : 0));
					c.barX = l;
					c.pointWidth = w;
	...
	(function(a) {
		...
		a.distribute = function(a, b) {
			...
			for (a = r(a, function(a) {
				...
				for (f = a.length; f--;) e = a[f], l = (Math.min.apply(0, e.targets) + Math.max.apply(0, e.targets)) / 2, e.pos = Math.min(Math.max(0, l - e.size * e.align), b - e.size);
				f = a.length;
		...
		h.prototype.drawDataLabels = function() {
			...
			if (e.enabled || b._hasPointLabels) b.dlProcessOptions && b.dlProcessOptions(e), w = b.plotGroup("dataLabelsGroup", "data-labels", B && !r ? "hidden" : "visible", e.zIndex || 6), B && (w.attr({
				...
				g && (e = n(m, h), k = f.getLabelConfig(), C = e[f.formatPrefix + "Format"] || e.format, x = G(C) ? l(C, k) : (e[f.formatPrefix + "Formatter"] || e.formatter).call(k, e), C = e.style, k = e.rotation, C.color = v(e.color, C.color, b.color, "#000000"), "contrast" === C.color && (f.contrastColor = q.getContrast(f.color || b.color), C.color = e.inside || 0 > v(f.labelDistance, e.distance) || d.stacking ? f.contrastColor : "#000000"), d.cursor && (C.cursor = d.cursor), p = {
					fill: e.backgroundColor,
		...
		h.prototype.alignDataLabel = function(a, b, c, e, h) {
			...
			if (w && (p = c.style.fontSize, p = d.renderer.fontMetrics(p, b).b, e = g({
		...
		h.prototype.justifyDataLabel = function(a, b, c, e, g, h) {
			...
			m = c.x + e.width - q;
			m > d.plotWidth && ("left" === f ? b.align = "right" : b.x = d.plotWidth - m, n = !0);
			m = c.y + q;
		...
		m.pie && (m.pie.prototype.drawDataLabels = function() {
			var c = this,
				...
				M, P, I, Q, z = [0, 0, 0, 0];
			c.visible && (g.enabled || c._hasPointLabels) && (p(b, function(a) {
				...
				var h, m, t = b.length,
					x = [],
					w;
				if (t) for (c.sortByAngle(b, f - .5), 0 < c.maxLabelDistance && (h = Math.max(0, A - q - c.maxLabelDistance), m = Math.min(A + q + c.maxLabelDistance, e.plotHeight), p(b, function(a) {
				...
				}), a.distribute(x, m + w - h)), Q = 0; Q < t; Q++) d = b[Q], m = d.positionsIndex, k = d.labelPos, E = d.dataLabel, I = !1 === d.visible ? "hidden" : "inherit", P = h = k[1], x && G(x[m]) && (void 0 === x[m].pos ? I = "hidden" : (u = x[m].size, P = d.top + x[m].pos)), delete d.positionIndex, M = g.justify ? D[0] + (f ? -1 : 1) * (q + d.labelDistance) : c.getX(P < d.top + 2 || P > d.bottom - 2 ? h : P, f, d), E._attr = {
					visibility: I,
					align: k[6]
				}, E._pos = {
					x: M + g.x + ({
			...
			var b = this.center,
				...
				g = c.minSize || 80,
				h, l = null !== c.size;
			l || (null !== f[0] ? h = Math.max(b[2] - Math.max(a[1], a[3]), g) : (h = Math.max(b[2] - a[1] - a[3], g), b[0] += (a[3] - a[1]) / 2), null !== f[1] ? h = Math.max(Math.min(h, b[2] - Math.max(a[0], a[2])), g) : (h = Math.max(Math.min(h, b[2] - a[0] - a[2]), g), b[1] += (a[0] - a[2]) / 2), h < b[2] ? (b[2] = h, b[3] = Math.min(e(c.innerSize || 0, h), h), this.translate(b), this.drawDataLabels && this.drawDataLabels()) : l = !0);
			return l
		});
		m.column && (m.column.prototype.alignDataLabel = function(a, b, c, e, g) {
			...
			l && (e = n(l), 0 > e.y && (e.height += e.y, e.y = 0), l = e.y + e.height - f.yAxis.len, 0 < l && (e.height -= l), d && (e = {
				...
				width: e.height,
				height: e.width
			}), p || (d ? (e.x += m ? 0 : e.width, e.width = 0) : (e.y += m ? e.height : 0, e.height = 0)));
	...
	(function(a) {
		...
		D.prototype.hideOverlappingLabels = function(a) {
			var g = a.length,
				p, n, w, v, e, h, m, c, f, b = function(a, b, c, f, e, g, h, l) {
					return !(e > a + c || e + h < a || g > b + f || g + l < b)
				};
			for (n = 0; n < g; n++) if (p = a[n]) p.oldOpacity = p.opacity, p.newOpacity = 1, p.width || (w = p.getBBox(), p.width = w.width, p.height = w.height);
			a.sort(function(a, b) {
				return (b.labelrank || 0) - (a.labelrank || 0)
			});
			for (n = 0; n < g; n++) for (w = a[n], p = n + 1; p < g; ++p) if (v = a[p], w && v && w !== v && w.placed && v.placed && 0 !== w.newOpacity && 0 !== v.newOpacity && (e = w.alignAttr, h = v.alignAttr, m = w.parentGroup, c = v.parentGroup, f = 2 * (w.box ? 0 : w.padding || 0), e = b(e.x + m.translateX, e.y + m.translateY, w.width - f, w.height - f, h.x + c.translateX, h.y + c.translateY, v.width - f, v.height - f)))(w.labelrank < v.labelrank ? w : v).newOpacity = 0;
			B(a, function(a) {
				var b, c;
	...
	(function(a) {
		...
		J = a.TrackerMixin = {
			...
			drawTrackerGraph: function() {
				...
				if (f && !c) for (m = f + 1; m--;)"M" === d[m] && d.splice(m + 1, 0, d[m + 1] - l, d[m + 2], "L"), (m && "M" === d[m] || m === f) && d.splice(m, 0, "L", d[m - 2] + l, d[m - 1]);
				k ? k.attr({
					d: d
		...
		n(b.prototype, {
			...
			setState: function(a, b) {
				...
				if (!(a === this.state && !b || this.selected && "select" !== a || !1 === g.enabled || a && (k || m && !1 === p.enabled) || a && r.states && r.states[a] && !1 === r.states[a].enabled)) {
					...
					if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.animate(e.pointAttribs(this, a), f(v.options.chart.animation, g.animation)), y && this.graphic.animate(y, f(v.options.chart.animation, p.animation, h.animation)), t && t.hide();
					else {
						if (a && p) {
							h = r.symbol || e.symbol;
					...
					}(c = g.halo) && c.size ? (w || (e.halo = w = v.renderer.path().add((this.graphic || t).parentGroup)), w[b ? "animate" : "attr"]({
		...
		n(d.prototype, {
			...
			setState: function(a) {
				...
				}), b.state = a, !e[a] || !1 !== e[a].enabled) && (a && (g = e[a].lineWidth || g + (e[a].lineWidthPlus || 0)), d && !d.dashstyle)) for (g = {
					"stroke-width": g
		...
		D.prototype.currentOptions = function(l) {
			function n(e, h, l, c) {
				...
				a.objectEach(e, function(a, d) {
					if (!c && -1 < G(d, ["series", "xAxis", "yAxis"])) for (a = r(a), l[d] = [], f = 0; f < a.length; f++) h[d][f] && (l[d][f] = {}, n(a[f], h[d][f], l[d][f], c + 1));
					else g(a) ? (l[d] = p(a) ? [] : {}, n(a, h[d] || {}, l[d], c + 1)) : l[d] = h[d] || null
				})
			}
			var v = {};
			n(l, this.options, v, 0);
			return v
		}
	})(N);
	return N
