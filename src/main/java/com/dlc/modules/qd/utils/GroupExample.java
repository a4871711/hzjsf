...
public class GroupExample {
	 ...
	 * 此处替换成您的appKey
	 * */
	private static final String appKey = "8luwapkv8jsbl";
	/**
	 * 此处替换成您的appSecret
	 * */
	private static final String appSecret = "W5QGm3ifVtepj";
	/**
	 * 自定义api地址
	 * */
	...
	public static void main(String[] args) throws Exception {
		...
		*//**
		 ...
		 *
		 *//*
		GroupMember[] members = {new GroupMember().setId("10001"),new GroupMember().setId("10001")};
