...
public class SysWalletDetailController {
    @Autowired
    private SysWalletDetailService walletDetailService;
    ...
    public R update(@RequestBody WalletDetailEntity walletDetail) {
        ...
        return walletDetailService.updateWalletDetailStatus(walletDetail, Constant.WalletDetailStatus.CHECK_FAILED.getValue());
    }
    ...
    public R payToUser(@RequestBody WalletDetailEntity walletDetail) throws Exception {
        ...
        return walletDetailService.updateWalletDetailStatus(walletDetail, Constant.WalletDetailStatus.CHECK_PAY_SUCCESS.getValue());
    }
