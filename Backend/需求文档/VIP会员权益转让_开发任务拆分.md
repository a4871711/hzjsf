...
|---|---|---|---|---|
| 1 | 数据库 DDL 脚本 | 地基 | — | ✅ 已完成 |
| 2 | 公共常量 + 统一返回码 | 地基 | 1 | ✅ 已完成 |
| 3 | ~~门店等级~~ 已废弃（适用门店校验并入第 9 步前置校验） | — | — | — |
| 4 | 转让费用规则 vip_fee_rule 后台 CRUD | 独立小项 | 1,2 | ✅ 已完成 |
| 5 | 权益卡商品 vip_benefit_card 后台 CRUD | 独立小项 | 1,2,4 | ✅ 已完成 |
| 6 | 动态定价 + 权益卡 list/detail（移动端） | 独立小项 | 1,2,5 | ✅ 已完成 |
| 7 | 权益卡购买 buy + 微信回调激活 + myBenefits | 独立小项 | 1,2,6 | ✅ 已完成 (commit f0b3887) |
