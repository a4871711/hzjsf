...
function createJqgrid() {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {
                label: '待审核模块', name: 'module', index: 'module', width: 80,
                formatter: function (val, option, row) {
                    // return "<a href='" + row.href + "'>" + val + "</a>"
                    return val;
                }
            },
            {label: '时间', name: 'createTime', index: 'createTime', width: 180}
        ],
        viewrecords: true,
        rowNum: 10000000000,
        rownumbers: true,
