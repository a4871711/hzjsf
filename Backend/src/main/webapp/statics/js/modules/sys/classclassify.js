$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'sys/classClassify/list',
        datatype: "json",
        colModel: [
            ...
            {label: '类型名称', name: 'dataName', index: 'dataName', width: 50},
            {label: '类型编号', name: 'price', index: 'price', width: 50},
            //{label: '课程最高售价(元/节)', name: 'val', index: 'val', width: 50},
            {
...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            ...
            var url = vm.dataMapEntityList.dataMapId == null ? "sys/classClassify/save" : "sys/classClassify/update";
            $.ajax({
                type: "POST",
                url: baseURL + url,
