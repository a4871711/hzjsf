...
public enum CodeAndMsg {
    ...
    ERROR_VIP_TRANSFER_HAS_NATURE_CARD(-67,"名下有生效中的权益类型会员卡，暂不可转让"),
    ...
    // 停卡前置条件：权益已激活但 start_time 晚于当前时间时，不能提前申请免费或付费停卡；借用早期空闲位 -39
    ERROR_PAUSE_BENEFIT_NOT_EFFECTIVE(-39,"权益还未生效，暂不能请假"),
    // 权益性质月卡购买边界：单次最多12张，且本次购买周期的起始日不能晚于当前权益到期日；借用早期空闲位 -40
    ERROR_FIT_CARD_MONTH_LIMIT(-40,"当前权益最多购买12张月卡，权益最后1个月最多购买1张"),

    /* ===== 私教管理后台业务码(全局收口,唯一来源;避开 -1~-40 / 101~104 / VIP -50~-79) ===== */
    /* —— 交易域 -80 ~ -99 —— */
