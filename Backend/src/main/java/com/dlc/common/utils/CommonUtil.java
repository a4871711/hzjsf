...
public class CommonUtil {
	...
	public static String httpsRequest(String requestUrl, String requestMethod, String outputStr) {
	    try {
	        ...
	        if (requestUrl.toLowerCase().startsWith("https://")) {
		    	...
		    	log.error("请求结果：{}", buffer.toString());
	...
	public static BigDecimal tryToBigDecimal(String str) {
    	if(StringUtils.isEmpty(str))return BigDecimal.ZERO;
	...
	public static String[] tryStrings(String str) {
		if(StringUtils.isEmpty(str))return new String[] {};
		return str.split(",");
	}
	
	public static Integer tryToInt(Integer str) {
