...
public interface VipBenefitService {
     ...
     * flashSaleActivityId 为限时秒杀活动ID(可空);命中则用秒杀价成交(暂停动态涨价)、秒杀限购叠加、来源登记到 vip_benefit
     */
    Map<String, Object> buy(UserInfoVo user, Long vipCardId, Long storeId, Long storeAddrId, Long flashSaleActivityId);
