...
-- 4) 「异常预警中心」菜单 → 前端 views/modules/sys/exceptionWarning.vue；perms 平铺 5 个按钮
INSERT INTO sys_menu (parent_id, name, url, perms, type, icon, order_num)
...
-- 5) 「私教收入报表」菜单 → 前端 views/modules/sys/privateReport.vue；perms 平铺 1 个按钮
INSERT INTO sys_menu (parent_id, name, url, perms, type, icon, order_num)
