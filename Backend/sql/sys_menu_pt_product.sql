...
-- 2) 「商品类型管理」菜单 → 前端 views/modules/sys/ptProductType.vue；perms 平铺 6 个按钮
INSERT INTO sys_menu (parent_id, name, url, perms, type, icon, order_num)
SELECT t.menu_id, '商品类型管理', 'modules/sys/ptProductType.html',
       'sys:ptproducttype:list,sys:ptproducttype:info,sys:ptproducttype:save,sys:ptproducttype:update,sys:ptproducttype:delete,sys:ptproducttype:updateStatus',
       1, 'fa fa-tags', 5
