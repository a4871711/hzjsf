...
CREATE TABLE `pt_coach_fee_rule` (
  ...
  `rule_type` TINYINT NOT NULL DEFAULT 1 COMMENT '提成方式:1按课时提成 2整单提成', -- 【补充】
  `lesson_fee` DECIMAL(10,2) DEFAULT NULL COMMENT '历史固定课时费兼容列;新规则统一写0', -- 【调整】由NOT NULL放宽为DEFAULT NULL
  `commission_rate` DECIMAL(5,2) DEFAULT NULL COMMENT '提成比例%;两种提成方式均必填', -- 【补充】
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='教练提成规则表(扩展版;全系统唯一建表口径,运营域报表只读引用)';
